  ...
  private  boolean servletOutput;
		...
		throws KettleXMLException
	{
      ...
      servletOutput         = "Y".equalsIgnoreCase(XMLHandler.getTagValue(stepnode, "file", "servlet_output"));
			...
			fileFolder            = XMLHandler.getTagValue(stepnode, "file", "fileFolder");
			...
			fileFolder = XMLHandler.getTagValue(stepnode, "fileFolder");
	...
	public String getXML()
	{
        ...
        retval.append("    "+XMLHandler.addTagValue("fileFolder", fileFolder));
		...
		throws KettleException
	{
		try
		{
			...
			fileFolder          =  rep.getStepAttributeString(id_step, "fileFolder");
			if (fileCompression == null)
			{
		...
		throws KettleException
	{
      ...
      rep.saveStepAttribute(id_transformation, id_step, "file_servlet_output",  servletOutput);
			...
			rep.saveStepAttribute(id_transformation, id_step, "fileFolder", fileFolder);
