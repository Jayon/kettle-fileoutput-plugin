	...
	public synchronized boolean processRow(StepMetaInterface smi, StepDataInterface sdi) throws KettleException {
		...
		if (r != null && first) {
			...
			if (meta.isFileNameInField()) {
				...
				if(meta.getFileFolder()!=null && !"".equals(meta.getFileFolder())){
					data.fileName = meta.getFileFolder()+File.separator+data.fileNameMeta.getString(r[data.fileNameFieldIndex]);
				}else{
					data.fileName = data.fileNameMeta.getString(r[data.fileNameFieldIndex]);
				}
		...
		if (meta.isFileNameInField()) {
			...
			if(meta.getFileFolder()!=null && !"".equals(meta.getFileFolder())){
				baseFilename = meta.getFileFolder()+File.separator+data.fileNameMeta.getString(r[data.fileNameFieldIndex]);
			}else{
				baseFilename = data.fileNameMeta.getString(r[data.fileNameFieldIndex]);
			}
